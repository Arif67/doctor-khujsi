<form action="{{ route('admin.sections.home.hero.update') }}" 
    ...
    <div class="flex flex-row justify-between items-center ">
        <h4 class="text-xl font-semibold text-gray-800 mb-3">Home Hero Section</h4>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
            ...
            <input type="file" name="photo" id="photo" 
                   class="w-full border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
        </div>
        <div>
