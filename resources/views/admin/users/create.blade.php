...
<div class="">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-gray-700 mb-1 font-semibold" for="hospital_name">Hospital Name</label>
                    <input type="text" name="hospital_name" id="hospital_name" value="{{ old('hospital_name') }}" placeholder="Enter hospital name"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
                    @error('hospital_name')
                        <span class="text-[red] font-semibold">{{ $message }}</span>
                    @enderror
                ...
                <div>
                    <label class="block text-gray-700 mb-1 font-semibold" for="hospital_location">Full Location</label>
                    <input type="text" name="hospital_location" id="hospital_location" value="{{ old('hospital_location') }}" placeholder="Enter full location"
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-gray-700 mb-1 font-semibold" for="district_id">Jila</label>
                    <select name="district_id" id="district_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
                ...
                <div>
                    <label class="block text-gray-700 mb-1 font-semibold" for="thana_id">Thana</label>
                    <select name="thana_id" id="thana_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
                ...
                <div>
                    <label class="block text-gray-700 mb-1 font-semibold" for="area_id">Area</label>
                    <select name="area_id" id="area_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
