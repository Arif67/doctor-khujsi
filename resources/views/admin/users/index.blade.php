            ...
            <table class="min-w-full table-auto border border-gray-200" id="users-table">
                <thead class="bg-gray-100 text-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-2 border-b">Approval</th>
...
$(document).ready(function() {
    $('#users-table').DataTable({
        ...
        columns: [
            ...
            { data: 'name', name: 'name' },
            { data: 'hospital_name', name: 'hospital_name', defaultContent: '-' },
    ...
    $(document).on('click', '.open-reject-hospital-modal', function () {
        $('#reject_reason').val('');
        $('#reject-hospital-form').attr('action', $(this).data('href'));
        $('#reject-hospital-modal').modal('show');
    });
});
</script>
@endpush
